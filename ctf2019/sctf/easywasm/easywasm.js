...
var Module = (function() {
  ...
  return function(Module) {
    ...
    var ASM_CONSTS = []; /*__ATINIT__.push();*/ /* no memory initializer */

    // STATICTOP = STATIC_BASE + 4176;
    /* global initializers */ var tempDoublePtr = 5184;
    ...
    asm["_login"] = function() {
      ...
      return real__login.apply(null, arguments);
    };
    ...
    var real__profile = asm["_profile"];
    asm["_profile"] = function() {
      assert(
        runtimeInitialized,
        "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
      );
      ...
      return real__profile.apply(null, arguments);
    };

    var real__registered = asm["_registered"];
    asm["_registered"] = function() {
      assert(
        runtimeInitialized,
        "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
      );
      ...
      return real__registered.apply(null, arguments);
    };
    ...
    var _login = (Module["_login"] = function() {
      assert(
        runtimeInitialized,
        "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
      );
      ...
      return Module["asm"]["_login"].apply(null, arguments);
    });
    ...
    var _profile = (Module["_profile"] = function() {
      assert(
        runtimeInitialized,
        "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
      );
      ...
      return Module["asm"]["_profile"].apply(null, arguments);
    });
    var _registered = (Module["_registered"] = function() {
      assert(
        runtimeInitialized,
        "you need to wait for the runtime to be ready (e.g. wait for main() to be called)"
      );
      ...
      return Module["asm"]["_registered"].apply(null, arguments);
    });

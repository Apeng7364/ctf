...
int main()
{
	long key[4] = { 0xE0C7E0C7, 0xC6F1D3D7, 0xC6D3C6D3, 0xC4D0D2CE };
	string res = "5f8243a662cf71bf31d2b2602638dc1d";

	int i;
	for (i = 0; i < 256; i++)
	{
		long plain[2] = { 0x70797e55,0x02003678 };
		plain[1] += i * 0x10000;
		btea(plain, 2, key);
	//	cout << hex << plain[0] <<' '<< plain[1] << endl;
		char a[9] = {};
		memcpy(a, plain, 8);
		char b[17] = {};
		int j;
